...
def movePlayer(elapsedSec):
    ...
    if playerInWater and playerMoveDirection == 1:
        if playerTotalElapsedSec > (playerMovementSpeed * 0.0001) * 5:
            playerTotalElapsedSec %= (playerMovementSpeed * 0.0001) * 5
            playerTotalElapsedSecPast = True

    elif playerInWater and playerMoveDirection == -1:
        if playerTotalElapsedSec > (playerMovementSpeed * 0.0001) / 3:
            playerTotalElapsedSec %= (playerMovementSpeed * 0.0001) / 3
            playerTotalElapsedSecPast = True

    elif not playerInWater and (playerMoveDirection == 1 or playerMoveDirection == -1):
        if playerTotalElapsedSec > (playerMovementSpeed * 0.0001):
            playerTotalElapsedSec %= (playerMovementSpeed * 0.0001)
            playerTotalElapsedSecPast = True
